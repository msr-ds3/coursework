...
cut -d, -f2 201402* | tr ' ' '\n' | grep '[0-9]*[-/][0-9]*[-/][0-9]*' | sort | uniq -c
# find the day with the most rides
cut -d, -f2 201402* | tr ' ' '\n' | grep '[0-9]*[-/][0-9]*[-/][0-9]*' | sort | uniq -c | sort -n | tail -n1
# find the day with the fewest rides
cut -d, -f2 201402* | tr ' ' '\n' | grep '[0-9]*[-/][0-9]*[-/][0-9]*' | sort | uniq -c | sort -n | head -n1
...
# complete the trip variance with only 3 variables
