...
cat 201402-citibike-tripdata.csv | cut -d, -f2 | sort |  grep -o '.* ' | uniq -c

# find the day with the most rides
cat 201402-citibike-tripdata.csv | cut -d, -f2 | sort |  grep -o '.* ' | uniq -c | sort -r | head -n1 | awk '{print $2}'

# find the day with the fewest rides
cat 201402-citibike-tripdata.csv | cut -d, -f2 | sort |  grep -o '.* ' | uniq -c | sort | head -n1 | awk '{print $2}'

# find the id of the bike with the most rides
cat 201402-citibike-tripdata.csv | cut -d, -f12 | sort | uniq -c | sort -r | head -n1 | awk '{print $2}'

# count the number of rides by gender and birth year
cat 201402-citibike-tripdata.csv | cut -d, -f14,15 | sort | uniq -c | wc -l
