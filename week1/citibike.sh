...
# count the number of trips per day
  ...
  12036 2014-02-27
   9587 2014-02-28
   cut -d, -f2 201402-citibike-tripdata.csv | cut -d " " -f1 | uniq -c
# find the day with the most rides
13816 2014-02-02
cut -d, -f2 201402-citibike-tripdata.csv | cut -d " " -f1 | uniq -c | sort
# find the day with the fewest rides
876 2014-02-13
cut -d, -f2 201402-citibike-tripdata.csv | cut -d " " -f1 | uniq -c | sort -r
...
awk -F, '{ x=$1 ; n++; avg=(x + (n-1)*avg)/ n  } END {print (avg)}' 201402-citibike-tripdata.csv
874.516
