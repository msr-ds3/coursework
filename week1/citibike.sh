...
cut -d, -f2 201402-citibike-tripdata.csv | cut -f1 -d" " | sort | uniq -c

# find the day with the most rides
cut -d, -f2 201402-citibike-tripdata.csv | cut -f1 -d" " | sort | uniq -c | sort | tail -n1

# find the day with the fewest rides
cut -d, -f2 201402-citibike-tripdata.csv | cut -f1 -d" " | sort | uniq -c | sort | head -n2 | tail -n1
