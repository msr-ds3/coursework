...
cat 201402-citibike-tripdata.csv | cut -d, -f2 | cut -d' ' -f1 | sort | uniq -c | sort -r | head
# ANSWER: Feb 02

# find the day with the fewest rides
cat 201402-citibike-tripdata.csv | cut -d, -f2 | cut -d' ' -f1 | sort | uniq -c | sort | head
# ANSWER: Feb 13

# find the id of the bike with the most rides
cat 201402-citibike-tripdata.csv | cut -d, -f12 | sort | uniq -c | sort -r | head
# ANSWER: 130
