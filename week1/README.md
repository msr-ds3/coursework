...
# Command line
  ...
  * Rename the file to get rid of ugly spaces: ``mv 2014-02*.csv 201402-citibike-tripdata.csv``
  * Go through the one-liners in the ``explore_trips.sh`` file
  * Fill in solutions of your own for ``exercises.sh``
