...
ds3@vaishnavi-surface MINGW64 ~/Desktop/DS3/coursework/week1 (master)
$ cut -d, -f5 201402-citibike-tripdata.csv | sort| uniq -c | wc -l
330

ds3@vaishnavi-surface MINGW64 ~/Desktop/DS3/coursework/week1 (master)
$ cut -d, -f9 201402-citibike-tripdata.csv | sort| uniq -c | wc -l
330
# count the number of unique bikes
s3@vaishnavi-surface MINGW64 ~/Desktop/DS3/coursework/week1 (master)
...
ds3@vaishnavi-surface MINGW64 ~/Desktop/DS3/coursework/week1 (master)
$ awk -F, '{counts[$1]++} END {for (k in counts) sum  +=  counts[k]* k } END { print(sum / NR)}' 201402-citi
bike-tripdata.csv
874.516