...
# best_model5 <- lm(num_trips ~ poly(tmin, 1, raw=T), data=trips_per_day_with_all_info_and_holidays_train)
...
test_err <- sqrt(mean((predict(best_model5, trips_per_day_with_all_info_and_holidays_test) - trips_per_day_with_all_info_and_holidays_test$num_trips)^2))
...
save(best_model5, file='citibike_model.Rdata')
