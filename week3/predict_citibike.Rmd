...
author: "Fabio Pecora and Shimmy Greengart"
date: "2024-06-21"
...
```{r}
bank_holidays <- read_csv(here('week3/4758439-a33943da19bd8512f41cd369332ee7e805eb373c/US Bank holidays (up to 2020)'), col_names=c("holidy_id", "ymd", "holiday_name"))
