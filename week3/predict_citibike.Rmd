...
For anyone testing this, the preprocess_data function must be called on test data to add some columns, and the model you are using is called final_model.
