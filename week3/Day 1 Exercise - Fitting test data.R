...
trips_per_day_train_plot <- trips_per_day_train %>%
  add_predictions(model) %>%
  mutate(split = "train")
trips_per_day_validation_plot <- trips_per_day_validation %>%
  add_predictions(model) %>%
  mutate(split = "validate")
trips_per_day_test_plot <- trips_per_day_test %>%
  add_predictions(model) %>%
  mutate(split = "test")
plot_data <- bind_rows(trips_per_day_train_plot, trips_per_day_validation_plot, trips_per_day_test_plot)
