...
cv.error.10
power.prop.test(p1=0.400, p2=0.40001, sig.level=0.1, power=0.80, alternative="one.sided")
...
# coffee and cancer answer 
# 1. power.prop.test(n=100000, p1=0.400, p2=0.401, sig.level=0.01, power=0.80, alternative="one.sided")
#  -> 21637831282
# 2. The biggest challenge that i think may occur is that we cannot get a sample size of 21637831282, there arent even 
# enough people in te world for this to tested on. 
