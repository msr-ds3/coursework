...
[ -f googlebooks-eng-all-totalcounts-20120701.txt ] || curl -o googlebooks-eng-all-totalcounts-20120701.txt https://storage.googleapis.com/books/ngrams/books/googlebooks-eng-all-totalcounts-20120701.txt
