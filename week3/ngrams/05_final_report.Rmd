...
> I believe the plot does not lead me to reevaluate the results because plot d is a simple count of the number of mentions a term has, but the plot doesn't compare that number with the toal mentions per year. 
...
>In the data we collected, there were some timeframes that represented outliers. The one that stood out to us the most was 1850-1860s and one possible reason for the outlier represented was the events leading up to and during the civil war. Additionally, there are possible reasons that you would notice a tick up in raw mentions for years ending in zeros. One reason I believe is the way languages reference history. For example, when referencing music people generally refer to the decade like the 80s, 90s, or 2000s. 
