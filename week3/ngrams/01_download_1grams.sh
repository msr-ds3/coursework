...
[ -f googlebooks-eng-all-1gram-20120701-1.gz ] || curl -o googlebooks-eng-all-1gram-20120701-1.gz http://storage.googleapis.com/books/ngrams/books/datasetsv2.html
