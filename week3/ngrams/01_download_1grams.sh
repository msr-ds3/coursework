...
[ -f googlebooks-eng-all-1gram-20120701-1.gz ] || curl -o googlebooks-eng-all-1gram-20120701-1.gz https://storage.googleapis.com/books/ngrams/books/googlebooks-eng-all-1gram-20120701-1.gz 
